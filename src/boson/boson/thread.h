...
using thread_command_data = json_backbone::variant<std::nullptr_t, routine<StackTraits>>;
...
class thread {
  ...
  //std::vector<std::unique_ptr<routine_t>> scheduled_routines_;
  ...
  // Member function called by its matching C-Stymle callbacl
