...
void routine::resume(thread* managing_thread) {
  ...
  // request->queue->write(thread_->id(), request->data);
  //} else {
  // request->data = request->queue->read(thread_->id());
  //}
  // context_ = jump_fcontext(context_.fctx, nullptr);
  //}
}

// void routine::queue_write(queues::base_wfqueue& queue, void* data) {
...
//}
//
// void* routine::queue_read(queues::base_wfqueue& queue) {
